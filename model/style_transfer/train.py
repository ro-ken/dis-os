...
def start(content_image_path=None,style_image_path=None):

    if content_image_path is None:
        style_image_path = settings.STYLE_IMAGE_PATH
        content_image_path = settings.CONTENT_IMAGE_PATH
    # 创建模型
    ...
    for epoch in range(settings.EPOCHS):
        ...
        with tqdm(total=settings.STEPS_PER_EPOCH, desc='Epoch {}/{}'.format(epoch + 1, settings.EPOCHS)) as pbar:
            ...
            utils.save_image(noise_image, '{}/out.jpg'.format(settings.OUTPUT_DIR))
