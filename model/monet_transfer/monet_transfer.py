...
def make_parser():
    ...
    parser.add_argument("-s", "--save_path", default="outputs", type=str, help="outputs save file")

    parser.add_argument("-c", "--ckpt", default="weights/G_AB.pth", type=str, help="checkpoint file")

    parser.add_argument("-dp", "--data_path", default="datasets/input", type=str, help="input file")
